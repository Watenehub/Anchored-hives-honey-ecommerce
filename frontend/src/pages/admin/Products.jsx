...
const Products = () => {
  ...
  const products = [
    { id: 1, name: 'Pure Organic Honey', category: 'Raw Honey', price: 2500, stock: 50, status: 'Active' },
    { id: 2, name: 'Wildflower Honey', category: 'Raw Honey', price: 2200, stock: 35, status: 'Active' },
    { id: 3, name: 'Manuka Honey', category: 'Specialty', price: 4500, stock: 20, status: 'Active' },
    { id: 4, name: 'Clover Honey', category: 'Raw Honey', price: 2000, stock: 45, status: 'Active' },
    { id: 5, name: 'Acacia Honey', category: 'Raw Honey', price: 2800, stock: 30, status: 'Active' },
    { id: 6, name: 'Buckwheat Honey', category: 'Specialty', price: 3200, stock: 25, status: 'Active' },
    { id: 7, name: 'Eucalyptus Honey', category: 'Raw Honey', price: 2400, stock: 40, status: 'Active' },
    { id: 8, name: 'Lavender Honey', category: 'Specialty', price: 3500, stock: 15, status: 'Active' },
    { id: 9, name: 'Orange Blossom Honey', category: 'Raw Honey', price: 2600, stock: 38, status: 'Active' },
    { id: 10, name: 'Comb Honey', category: 'Specialty', price: 4000, stock: 18, status: 'Active' },
    { id: 11, name: 'Creamed Honey', category: 'Raw Honey', price: 2300, stock: 42, status: 'Active' },
    { id: 12, name: 'Royal Jelly', category: 'Specialty', price: 5500, stock: 12, status: 'Active' },
  ]
